...
/**
 * Card renderer for the STATIC tutor profile pages (tutors/[id], tutors).
 *
 * These pages still run on the legacy marketplaceData.ts fixtures, which are
 * outside Phase 3C scope. The live marketplace uses MarketplaceGigCard, which
 * consumes the real backend Gig shape. This component will be removed when the
 * tutor pages are migrated to real APIs in a later phase.
 */
export default function StaticGigCard({ gig }: Props) {
