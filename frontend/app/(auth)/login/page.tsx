...
const roles = [
  {
    ...
    title: "Student",
    description:
      "Find your Ustaad, discover new skills, and continue your learning journey.",
    href: "/login/student",
  ...
  },
  {
    ...
    title: "Ustaad",
    description:
      "Connect with students, manage your gigs, and grow your teaching career.",
    href: "/login/teacher",
    cta: "Login as Ustaad",
  },
];
      ...
      <div className="relative mx-auto flex w-full max-w-3xl flex-1 flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center py-14">
          ...
          <p className="mt-4 text-center text-base text-white/60">
            Pick your role to access your Ustaad account.
          </p>
          ...
          <p className="mt-9 text-sm text-white/60">
            ...
            <Link href="/register" className="font-semibold text-[#D18A4A] transition hover:text-[#E5A15F]">
              Create an account
            </Link>
          </p>
        </div>
